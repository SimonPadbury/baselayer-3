...
<div class="wrapper mb-1 p-1 bg-gray bg-100">wrapper</div>
  <div class="wrapper flex flex-wrap mb-1 bg-gray bg-100">
...
<div class="wrapper mb-1 p-1 bg-gray bg-100">wrapper</div>
<div class="wrapper-xl mb-1 p-1 bg-gray bg-100">wrapper-xl</div>
<div class="wrapper-lg mb-1 p-1 bg-gray bg-100">wrapper-lg</div>
<div class="wrapper-md mb-1 p-1 bg-gray bg-100">wrapper-md</div>
<div class="wrapper-sm mb-1 p-1 bg-gray bg-100">wrapper-sm</div>
<div class="wrapper-xs mb-1 p-1 bg-gray bg-100">wrapper-xs</div>
...
<div class="wrapper">
  ...
  <label class="inline-block px-1 t-black bg-gray bg-200">Uncategorized</label>
</div>
...
<div class="wrapper-sm mb-2">
  <p>Full width button inside a small wrapper</p>
...
<div class="wrapper mb-3 ">
  <p class="w-sm">A malleable grid without equalization set. on the cell widths. In this example, for <code>sm</code> up, columns will adopt whatever width they require for their content. <em>CSS grid</em> requires column placement classes to know where you want your columns, so that it can figure out how many columns you need.</p>
...
<div class="wrapper container mt-2 mb-3">
  ...
  <div class="mt-1 grid md:equal-3-cols lg:equal-4-cols gap-3">
    ...
    <div class="md:col-2 md:col-span-2 lg:col-4 lg:row-1 lg:row-span-2 b-1 p-1 relative">
      <code class="mb-1">md:col-2 md:col-span-2 lg:col-4 lg:row-span-2 p-1 relative</code><br>
