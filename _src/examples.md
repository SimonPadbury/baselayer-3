  ...
  <div class="mt-2 mb-3 container resize-x">
    <div class="b-thin rounded rounded-2 p-3 sm:flex gap-2">
      ...
      <div class="grow flow">
        ...
        <p class="">In this example, the media object “collapses” to a single column below container width 640px, using <code>sm:flex</code>. And below that width, the title and button are centered using <code>t-center</code>, which is overridden by <code>sm:t-left</code>.</p>
