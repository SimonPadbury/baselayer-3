...
<div aria-label="Note" class="popout mb-2 bl-3 b-orange b-300 p-2 t-black bg-orange bg-100">
  ⚠ You need to add your color utilities as supplements to the <code>@layer color-setup</code> cascade layer, so that they get declared before the shades that are in the subsequent <code>@layer color-setup</code>.
</div>
